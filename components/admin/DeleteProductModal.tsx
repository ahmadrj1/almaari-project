...
export default function DeleteProductModal({ isOpen, onClose, onConfirm, isDeleting }: DeleteProductModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-8 text-center flex flex-col items-center">
        <h2 className="text-2xl font-semibold text-blue-500 mb-6">Remove Product</h2>
