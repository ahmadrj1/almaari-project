    ...
    <div className="flex flex-col space-y-6">
      ...
      >
        ...
        >
          <path
            fill="#4285F4"
            d="M488 261.8c0-16.7-1.5-32.9-4.3-48.5H248v91.8h134.8c-5.8 31.3-23.4 57.8-50 75.6v62.8h81c47.4-43.6 74.2-107.8 74.2-181.7z"
          ></path>
          <path
            fill="#34A853"
            d="M248 504c69.1 0 127.1-22.9 169.5-62.1l-81-62.8c-22.4 15-51.2 23.9-88.5 23.9-68.1 0-125.8-46-146.4-108H19.7v64.8C62 443.8 147.2 504 248 504z"
          ></path>
          <path
            fill="#FBBC05"
            d="M101.6 295c-5.2-15.6-8.2-32.3-8.2-49.7s3-34.1 8.2-49.7V130.8H19.7C2.2 165.6-7.8 204.8-7.8 245.3s10 79.7 27.5 114.5l81.9-64.8z"
          ></path>
          <path
            fill="#EA4335"
            d="M248 94.3c37.6 0 71.4 12.9 98 38.3l73.5-73.5C375.1 21.4 317.1 0 248 0 147.2 0 62 60.2 19.7 143.7l81.9 64.8C122.2 140.3 179.9 94.3 248 94.3z"
          ></path>
        </svg>
        Sign in with Google
      </Button>
      <div className="text-center text-sm">
        <span className="text-gray-600">
          ...
          <Link
            ...
            className="font-medium text-[#2979FF] whitespace-pre hover:text-[#2979FF]"
          >
            {" "}
            Reset
          </Link>
