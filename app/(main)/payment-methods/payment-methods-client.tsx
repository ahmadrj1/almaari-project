...
export default function PaymentMethodsClient() {
  ...
  const handleCardTokenized = (
    ...
    setShowAddNew(false);
    saveCard(paymentMethodId, setAsDefault ?? paymentMethods.length === 0);
  };
    ...
    <div className="w-full">
                  ...
                  <div className="flex items-center gap-3">
                    {!isDefault && paymentMethods.length > 1 && (
                      <button
                        ...
                        className="text-xs font-semibold text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100/70 px-3.5 py-2 rounded-xl transition disabled:opacity-50 flex items-center gap-1.5"
                      >
                        {isLoading && (
                          <svg
      ...
      >
        <Elements stripe={stripePromise}>
          <StripeCardForm
            showSetDefault={paymentMethods.length > 0}
